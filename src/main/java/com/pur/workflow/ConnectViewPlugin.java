...
import com.pur.entity.FlowNodeModel;
...
public class ConnectViewPlugin extends AbstractBillPlugIn implements IWorkflowDesigner {
        ...
        for (FlowNodeModel node : nodeList) {
            for (Object entity : jsonArray) {
                ...
                if (object.getString("id").equals(node.getNodeId())) {
                    if (object.containsKey("tpv_treeentryentity")) {
